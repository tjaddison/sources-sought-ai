#!/usr/bin/env python3
"""
Sources Sought Slack Integration MCP Server

Handles Slack integration for human-in-the-loop workflows, notifications,
and approval processes for the Sources Sought AI system.
"""
                ...
                "blocks": [
                    {
                        ...
                        "text": {
                            "type": "plain_text",
                            "text": "🎯 Sources Sought Opportunity Review"
                        }
                    },
                    {
                        "type": "section",
                ...
                "blocks": [
                    ...
                    },
                    {
                        ...
                        "elements": [
                            {
                                "type": "mrkdwn",
                                "text": f"🕐 {datetime.now().strftime('%Y-%m-%d %H:%M:%S')} | Sources Sought AI System"
                            }
                        ]
                    }
                ]
...
server = Server("sources-sought-slack-mcp")
...
async def handle_read_resource(uri: str) -> str:
    ...
    if uri == "slack://channels":
        channels = {
            "default_channels": {
                "notifications": "#sources-sought-notifications",
                "alerts": "#sources-sought-alerts",
                "approvals": "#sources-sought-approvals",
                "general": "#sources-sought-general"
            },
            "channel_purposes": {
        ...
        users_config = {
            ...
            "permission_descriptions": {
                "opportunity_approve": "Approve/reject sources sought opportunities",
        ...
        workflows = {
            "opportunity_approval": {
                "description": "Review and approve sources sought opportunities",
                "steps": [
...
2. **Slack App**: Create a new Slack app for Sources Sought AI
...
- `#sources-sought-notifications` - General notifications
- `#sources-sought-alerts` - Critical alerts
- `#sources-sought-approvals` - Approval workflows
- `#sources-sought-general` - General discussion

## Step 6: Add Bot to Channels

Invite the Sources Sought AI bot to all relevant channels:
...
await slack_client.call_tool("send_notification", {
    "channel": "#sources-sought-general",
