#!/usr/bin/env python3
"""
Sources Sought Relationship Management MCP Server

Manages government contacts, relationships, and CRM functionality
for the Sources Sought AI system.
"""
...
class ContactManager:
    ...
    def __init__(self, dynamodb_resource):
        ...
        self.contacts_table = dynamodb_resource.Table("sources-sought-contacts")
        self.relationships_table = dynamodb_resource.Table("sources-sought-relationships")
...
server = Server("sources-sought-crm-mcp")
